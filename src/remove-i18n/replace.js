...
const Second_Filepath = path.resolve('src/Second.jsx');
...
const routerFilePath = path.resolve('src/routes/index.jsx');
const homeFilePath = path.resolve('src/components/Home.jsx');
